<template>
  <header>
    <div>
      <div class="flex justify-between items-center h-16 shadow lg:hidden">
        <div class="flex w-2/3 items-center">
          <div class="ml-2">
            <img
              class="h-12 w-12"
              src="../../static/imgs/foundation@2x.jpg"
              alt
            />
          </div>
          <h1 class="ml-4 text-xl font-bold text-gray-700 font-logo">
            Foundation
          </h1>
        </div>
        <div class="w-1/3 flex justify-between">
          <div></div>
          <div
            class="border-l border-gray-500 h-16 w-16 flex justify-center items-center"
          >
            <svg
      ...
      <div
        v-if="isDropdownOpen"
        class="lg:hidden flex items-center mx-8 sm:flex-col"
      >
        <ul>
          <nuxt-link to>
            <li
          ...
          <nuxt-link to>
            <li
              @click="openSubNav"
              class="transition-fast my-2 font-bold text-lg text-gray-700"
            >
              <div class>
                  ...
                  <ul>
                    <nuxt-link to>
                      <li class="text-base my-4">
                        ...
                        <p class="text-sm">
                          Work with tools and service you use.
                        </p>
                      </li>
                    </nuxt-link>
                    <nuxt-link to>
                    ...
                    <nuxt-link to>
                      <li class="text-base my-4">
                        ...
                        <p class="text-sm">
                          We offer measures like 2FA to ensure saftey.
                        </p>
                      </li>
                    </nuxt-link>
                    <nuxt-link to>
                      <li class="text-base my-4">
                        ...
                        <p class="text-sm">
                          Become a better desigener by learning this course.
                        </p>
                      </li>
                    </nuxt-link>
                  </ul>
    ...
    <div
      class="hidden p-4 lg:bg-skin-pink lg:flex justify-between items-center lg:block"
    >
      <div class="flex">
        <div class="ml-2 mr-4">
          <img
        ...
        <div>
          <nuxt-link to="/">
            <h1 class="font-bold text-lg text-gray-100 ">
              Foundation
            </h1>
      ...
      <nav class="p-6 transition-all flex items-center relative">
        <ul class="flex ">
          <li
            ...
            :key="index"
            class="transition-fast mx-10 font-bold text-lg text-gray-100 hover:text-indigo-500"
          >
            <nuxt-link to>
              <div
                class="flex items-center "
                :class="link.isActive ? 'text-indigo-500' : ''"
              >
                {{ link.name }}
        ...
        <div
          ...
          v-if="isSubNavOpen"
          class="subdropdown absolute h-auto bg-gray-100 p-8 rounded shadow items-center justify-center"
        >
          <ul class="flex">
            <div>
              <li class="text-base my-4">
...
export default {
  ...
  data() {
    return {
      navLinks: [
        { name: "Home", hasSVG: false, isActive: true },
        { name: "Stories", hasSVG: false, isActive: false },
