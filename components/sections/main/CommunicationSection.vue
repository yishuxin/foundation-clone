<template>
  <section class="py-8 mx-4">
    <div class="sm:flex lg:mx-20 lg:items-center lg:mb-16">
      <div class="sm:w-1/2">
        <content-frame>
          <template #title>
            <h1 class="text-blue-500">Communicate Better</h1>
          </template>
          <template #subTitle>Built for busy small teams</template>
          <template #content>
        ...
        <div class="flex justify-center mt-4 mb-8 sm:w-1/2 lg:w-1/4">
          <base-button width="w-full" color="bg-indigo-600" textColor="text-white">Get Started</base-button>
        </div>
      </div>

      <figure-frame class="sm:w-1/2">
        <template #figure>
          <img class="h-auto w-64 lg:w-104" src="~/assets/imgs/rush-16@2x.png" alt />
        </template>
