<template>
  <section class="lg:bg-white">
    ...
    <div class="mx-4 my-4 lg:hidden">
      <content-frame>
        <template #title>Acquire Customers</template>
      ...
      <div class="sm:flex">
        <div class="sm:w-1/2">
          <div class="flex text-indigo-500 items-center">
            ...
            <h1 class="ml-2 font-bold text-xl leading-none py-2">Acquire new customers</h1>
          </div>
          <p class="my-2">Your team comes together to collaborate.</p>
        </div>

        <div class="p-2 border-b-4 border-indigo-500 sm:w-1/2 sm:mx-auto">
          <img src="../../static/imgs/app@2x.jpg" alt />
        </div>
      </div>
