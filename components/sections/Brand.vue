  ...
  <div>
    ...
    <section class="my-10 bg-white border-b lg:hidden">
      <div class="mx-4 sm:mx-20">
        <div class="pt-10 pb-6 flex flex-col items-center text-center">
          <img src="../../static/imgs/foundation-color.png" alt />
          <a href>
            <div>
        ...
        <div class="flex my-4 justify-around pb-10">
          <img src="../../static/imgs/appstore.png" alt />
          <img src="../../static/imgs/googleplay.png" alt />
        </div>
      </div>
    </section>
    <!-- For large screen -->
    <section class="hidden mb-10 bg-white border-b lg:block lg:border-none">
      <div class="mx-4 sm:mx-20">
        ...
        <div class="flex my-4 justify-around pb-10 lg:justify-center lg:mx-10">
          <img src="../../static/imgs/appstore.png" class="lg:mr-4" alt />
          <img src="../../static/imgs/googleplay.png" alt />
        </div>
      </div>
    </section>
